...
class Motorista extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nome, data_nascimento, email, telefone, placa, data_hora_status', 'required'),
			...
			array('id, nome, data_nascimento, email, telefone, placa, status, data_hora_status, obs', 'safe', 'on'=>'search'),
			...
			array('placa', 'match', 'pattern'=>'/^([A-Z]{3}-[0-9]{4}|[A-Z]{3}[0-9][A-Z][0-9]{2})$/',
				'message'=>'A placa deve seguir o padrão AAA-9999 ou AAA9A99.'),
